...
- 数据源：CSV + Excel
- 产出：Excel + JSON
- 关键脚本：SLG Monitor 3.0/pipeline/steps/*.py
- 一键入口：SLG Monitor 3.0/pipeline/run_full_pipeline.py
...
- 启动入口：SLG Monitor 3.0/server/start_server.py
- 功能：
  - 前端静态资源服务
  - 登录 / 权限校验
  - 数据维护与文件下载接口
...
- 本地运行：python server/start_server.py
