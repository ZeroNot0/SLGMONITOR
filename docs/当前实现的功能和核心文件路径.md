...
- 一键流程入口：SLG Monitor 3.0/run_full_pipeline.py
- 定时更新入口：SLG Monitor 3.0/schedule_update.py

### 2.2 分步脚本

- Step 1 合并去重：SLG Monitor 3.0/scripts/step1_merge_clean.py
- Step 2 映射归属：SLG Monitor 3.0/scripts/step2_mapping.py
- Step 3 指标计算：SLG Monitor 3.0/scripts/step3_metrics.py
- Step 4 透视汇总：SLG Monitor 3.0/scripts/step4_pivot.py
- Step 5 报告生成：SLG Monitor 3.0/scripts/step5_final_report.py
- Step 5.5 箭头颜色：SLG Monitor 3.0/scripts/step5_5_fix_arrow_color.py

### 2.3 目标产品生成

- 目标产品脚本：SLG Monitor 3.0/scripts/generate_target.py
...
- 静态服务启动：SLG Monitor 3.0/start_server.py
