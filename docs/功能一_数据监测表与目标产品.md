...
| 步骤 | 脚本 | 输入 | 输出 |
|------|------|------|------|
| STEP 1 | step1_merge_clean.py | raw_csv/{年}/{周}/ 下各品类 CSV | intermediate/{年}/{周}/merged_deduplicated.xlsx |
| STEP 2 | step2_mapping.py | merged + mapping(产品归属、公司归属、流水系数) | intermediate/{年}/{周}/mapped_total.xlsx |
| STEP 3 | step3_metrics.py | mapped_total + 流水系数 | intermediate/{年}/{周}/metrics_total.xlsx |
| STEP 4 | step4_pivot.py | metrics_total | intermediate/{年}/{周}/pivot_table.xlsx |
| STEP 5 | step5_final_report.py | pivot_table（删除条件①、周安装/流水变动、样式） | output/{年}/{周}_SLG数据监测表.xlsx |
| STEP 5.5 | step5_5_fix_arrow_color.py | 上表 | 同文件，仅修正箭头颜色 |
